...
<header class="symbol-info-header"><h1 id="mongooseindexoptions">MongooseIndexOptions</h1><label class="symbol-info-type-label interface">Interface</label></header>
<!-- summary -->
