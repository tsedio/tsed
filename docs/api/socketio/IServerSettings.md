...
<pre><code class="typescript-lang "><span class="token keyword">interface</span> IServerSettings <span class="token punctuation">{</span>
  socketIO?<span class="token punctuation">:</span> SocketIO.ServerOptions<span class="token punctuation">;</span>
...
<pre><code class="typescript-lang ">socketIO?<span class="token punctuation">:</span> SocketIO.ServerOptions</code></pre>
