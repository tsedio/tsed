...
<pre><code class="typescript-lang ">type Request<span class="token punctuation"> = </span>Express.Request<span class="token punctuation">;</span>
function <span class="token function">Request</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">:</span> Function<span class="token punctuation">;</span></code></pre>
