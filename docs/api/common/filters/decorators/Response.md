...
<pre><code class="typescript-lang ">type Response<span class="token punctuation"> = </span>Express.Response<span class="token punctuation">;</span>
function <span class="token function">Response</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">:</span> Function<span class="token punctuation">;</span></code></pre>
