<header class="symbol-info-header">    <h1 id="converterserializationerror">ConverterSerializationError</h1>    <label class="symbol-info-type-label class">Class</label>    <label class="api-type-label private">private</label>  </header>
<section class="symbol-info">      <table class="is-full-width">        <tbody>        <tr>          <th>Module</th>          <td>            <div class="lang-typescript">                <span class="token keyword">import</span> { ConverterSerializationError }                 <span class="token keyword">from</span>                 <span class="token string">"ts-express-decorators/lib/converters/errors/ConverterSerializationError"</span>                            </div>          </td>        </tr>        <tr>          <th>Source</th>          <td>            <a href="https://github.com/Romakita/ts-express-decorators/blob/v2.0.0-2/src/converters/errors/ConverterSerializationError.ts#L0-L0">                converters/errors/ConverterSerializationError.ts            </a>        </td>        </tr>                </tbody>      </table>    </section>
