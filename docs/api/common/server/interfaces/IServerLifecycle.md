...
meta:
 - name: keywords
   description: api typescript node.js documentation IServerLifecycle decorator
---
# IServerLifecycle <Badge text="Decorator" type="decorator"/>
<!-- Summary -->
<section class="symbol-info"><table class="is-full-width"><tbody><tr><th>Module</th><td><div class="lang-typescript"><span class="token keyword">import</span> { IServerLifecycle }&nbsp;<span class="token keyword">from</span>&nbsp;<span class="token string">"@tsed/common/src/server/interfaces/IServerLifeCycle"</span></div></td></tr><tr><th>Source</th><td><a href="https://github.com/Romakita/ts-express-decorators/blob/v4.31.4/packages/common/src/server/interfaces/IServerLifeCycle.ts#L0-L0">/packages/common/src/server/interfaces/IServerLifeCycle.ts</a></td></tr></tbody></table></section>
