<header class="symbol-info-header">    <h1 id="ihttpsfactory">IHttpsFactory</h1>    <label class="symbol-info-type-label decorator">Decorator</label>    <label class="api-type-label private">private</label>  </header>
