...
const apiSidebar = {
  groups: [
    {text: "Core", pattern: /core|@tsed\/di|hooks|schema$|\/exceptions$|engines|json-mapper|open-spec/},
    {text: "Platform", pattern: /platform/},
    {text: "ORM", pattern: /adapters|ioredis|mikro-orm|mongoose|objection|prisma/}
  ],
