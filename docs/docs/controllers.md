...
It also possible to give a custom handler for the `useType` parameters when you use a generic controller:

<<< @/docs/docs/snippets/controllers/params-use-type-handler.ts
