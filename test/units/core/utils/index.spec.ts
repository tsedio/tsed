      ...
      describe("when is an object", () => {
        ...
        it("should merge data", () => {
          expect(
            deepExtends(
              {
                parameters: [{in: "test", name: "get", description: "test"}, {in: "test", name: "post", description: "test"}]
              },
              {
                parameters: [{in: "test", name: "get", description: "test2"}, {in: "test", name: "util", description: "test2"}]
              },
              {
