...
describe("ServerSettingsProvider", () => {
    ...
    describe("Test ENV", () => {
        ...
        it("should have logging jsonIndentaion set to 2", () => {
            expect(this.serverSettingsService.logger.jsonIndentation).to.equal(2);
        });
    ...
    describe("Test PRODUCTION", () => {
        ...
        it("should return env PROD", () => {
            expect(this.serverSettingsService.env).to.equal(Env.PROD);
        });

        it("should have logging jsonIndentaion set to 0", () => {
            expect(this.serverSettingsService.logger.jsonIndentation).to.equal(0);
        });
    });
});
