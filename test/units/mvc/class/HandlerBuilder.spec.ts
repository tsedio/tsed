                ...
                before(() => {
                    ...
                    this.metadata = {
                        ...
                        services: [
                            ...
                            {service: ENDPOINT_INFO, useConverter: false, name: "endpointInfo", isValidRequiredValue: () => true},
                            {service: RESPONSE_DATA, useConverter: false, name: "responseData", isValidRequiredValue: () => true}
                        ]
                    };
