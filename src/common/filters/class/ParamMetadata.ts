...
export class ParamMetadata extends Storable implements IParamOptions<any> {
   ...
   *
   */
  @NotEnumerable() protected _expression: string | RegExp;
  /**
   *
   * @type {boolean}
   */
  @NotEnumerable() protected _useConverter: boolean = true;
  /**
   *
   * @type {boolean}
   */
  @NotEnumerable() private _useValidation: boolean = false;

  /**
   *
   */
  @NotEnumerable() protected _service: string | Type<any> | symbol;
