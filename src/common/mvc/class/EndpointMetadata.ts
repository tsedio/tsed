...
export class EndpointMetadata extends Storable {
   ...
   * @type {Array}
   */
  @NotEnumerable() private _beforeMiddlewares: any[] = [];
  /**
   *
   * @type {Array}
   * @private
   */
  @NotEnumerable() private _middlewares: any[] = [];
  /**
   *
   * @type {Array}
   * @private
   */
  @NotEnumerable() private _afterMiddlewares: any[] = [];
  /**
   ...
   * Route strategy.
   */
  @NotEnumerable() private _pathsMethods: ExpressPathMethod[] = [];
  /**
   * Endpoint inherited from parent class.
   */
  @NotEnumerable() private _inheritedEndpoint: EndpointMetadata;
