/**
 * The `@Deprecated()` decorator wraps the given method in such a way that it is marked as deprecated.
 *
 * ```typescript
 * class Foo {
 *
 ...
 * property is set to `true` prior to the first deprecation warning, the `@Deprecated()` decorator does nothing.
 *
