 ...
 * @returns {ParameterDecorator}
 */
export function Cookies(expression: string, useType: Type<any> | Function): ParameterDecorator;
export function Cookies(expression: string): ParameterDecorator;
export function Cookies(useType: Type<any> | Function): ParameterDecorator;
