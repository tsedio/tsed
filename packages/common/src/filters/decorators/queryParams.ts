 ...
 */
export function QueryParams(expression: string, useType: Type<any> | Function): ParameterDecorator;
export function QueryParams(expression: string): ParameterDecorator;
export function QueryParams(useType: Type<any> | Function): ParameterDecorator;
