import {EndpointMetadata, Get, Location, PlatformHeadersMiddleware, PlatformResponse, PlatformTest, Redirect, Status} from "@tsed/common";
...
describe("PlatformHeadersMiddleware", () => {
