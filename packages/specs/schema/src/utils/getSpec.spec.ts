...
import {CollectionOf, JsonParameterTypes, Property, Returns, SpecTypes} from "../index";
...
describe("getSpec()", () => {
  describe("In", () => {
    describe("Path", () => {
      ...
      it("should declare all schema correctly (expression - openspec3)", async () => {
        // WHEN
        class Controller {
          @OperationPath("GET", "/:id?")
    ...
    describe("Query", () => {
      it("should declare all schema correctly (query - openspec3)", async () => {
        // WHEN
        class Controller {
          @OperationPath("GET", "/:id")
    ...
    describe("Body", () => {
      ...
      it("should declare all schema correctly (Array - model - openspec3)", async () => {
        // WHEN
        class Product {
          @Property()
          title: string;
      ...
      it("should declare all schema correctly (Map - model - openspec3)", async () => {
        // WHEN
        class Product {
          @Property()
          title: string;
