...
import deprecatedOS3 from "./__mock__/deprecated/os3.spec.json" with {type: "json"};
import formParamOS2 from "./__mock__/form_param/os2.spec.json" with {type: "json"};
import formParamOS3 from "./__mock__/form_param/os3.spec.json" with {type: "json"};
import minimalOS2 from "./__mock__/minimal/os2.spec.json" with {type: "json"};
import minimalOS3 from "./__mock__/minimal/os3.spec.json" with {type: "json"};
import multipleRefOS2 from "./__mock__/multiple_ref/os2.spec.json" with {type: "json"};
import multipleRefOS3 from "./__mock__/multiple_ref/os3.spec.json" with {type: "json"};
import nestedOneOfOS2 from "./__mock__/nested_oneof/os2.spec.json" with {type: "json"};
import nestedOneOfOS3 from "./__mock__/nested_oneof/os3.spec.json" with {type: "json"};
import nullableOS2 from "./__mock__/nullable/os2.spec.json" with {type: "json"};
import nullableOS3 from "./__mock__/nullable/os3.spec.json" with {type: "json"};
import paramSchemaRefOS2 from "./__mock__/param_schema_ref/os2.spec.json" with {type: "json"};
import paramSchemaRefOS3 from "./__mock__/param_schema_ref/os3.spec.json" with {type: "json"};
import petstoreOS2 from "./__mock__/petstore/os2.spec.json" with {type: "json"};
import petstoreOS3 from "./__mock__/petstore/os3.spec.json" with {type: "json"};
import producesOS2 from "./__mock__/produces/os2.spec.json" with {type: "json"};
import producesOS3 from "./__mock__/produces/os3.spec.json" with {type: "json"};
import requestResponseRefOS2 from "./__mock__/request_response_ref/os2.spec.json" with {type: "json"};
import requestResponseRefOS3 from "./__mock__/request_response_ref/os3.spec.json" with {type: "json"};
import serversOS2 from "./__mock__/servers/os2.spec.json" with {type: "json"};
