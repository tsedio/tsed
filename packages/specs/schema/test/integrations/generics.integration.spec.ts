...
describe("Generics: basic", () => {
  describe("JsonSchema", () => {
    it("should generate the JsonSchema from given options: Paginated", () => {
      class Product {
        @MinLength(10)
        label: string;
      }
    ...
    it("should generate the JsonSchema from given options: Paginated<Product>", () => {
      class Product {
        @MinLength(10)
        label: string;
      }
    ...
    it("should generate the JsonSchema with nested models: Paginated<Submission<Product>>", () => {
      @Generics("T")
      class Paginated<T> {
        @CollectionOf("T")
        data: T[];
